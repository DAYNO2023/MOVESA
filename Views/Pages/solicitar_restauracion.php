        ...
        <div class="login-card">
            <div class="login-aside flex justify-content-center align-items-center">
                <div>
                    ...
                    <img src="../Resources/dist/img/MOVESA-fondo-rojo.png" alt="Home Icon" id="logo">
            ...
            <div class="login-aside-container">
                <div class="login-container d-none" id="login-container">
                    ...
                    <div class="form-group">
                                ...
                                <input type="text" name="usuario" class="form-control" id="exampleInputUsername1" required>
                            </div>
