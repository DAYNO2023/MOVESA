<?php
// Convierte un CSV a XLSX usando PhpSpreadsheet para el CSV generado
require __DIR__ . '/../vendor/autoload.php';

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;

$csvPath = __DIR__ . '/../uploads/generated_data_ventas.csv';
$xlsPath = __DIR__ . '/../uploads/generated_data_ventas.xlsx';
